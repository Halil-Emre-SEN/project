...
public class days {
	...
	/*
	 * Given an int , if the int is 1 print monday if the int is 2 print tuesday if
	 * the int is 3 print wednesday if the int is 4 print thursday if the int is 5
	 * print friday if the int is 6 print saturday if the int is 7 print sunday if
	 * the number more then 8 print "this is not a valid day"
	 * 
