...
public class test1 {
	...
	public void days1() {
		...
		Assert.assertTrue("output friday olmalı ama siziin output" + getOutput(),
				getOutput().toLowerCase().contains("friday"));
	}
	...
	public void days2() {
		...
		Assert.assertTrue("output tuesday olmalı ama siziin output" + getOutput(),
				getOutput().toLowerCase().contains("tuesday"));
	}
	...
	public void days3() {
		...
		Assert.assertTrue("output sunday olmalı ama sizin output" + getOutput(),
				getOutput().toLowerCase().contains("sunday"));
	}
	...
	public void days4() {
		...
		Assert.assertTrue("output  this is not a valid day olmalı ama sizin output " + getOutput(),
				getOutput().toLowerCase().contains("this is not a valid day"));
	}
	...
	public void age1() {
		...
		Assert.assertTrue("output  ehliyet almak icin cok gencsin olmalı ama sizin output :: " + getOutput(),
				getOutput().toLowerCase().contains("ehliyet almak icin cok gencsin"));
	}
	...
	public void age2() {
		...
		Assert.assertTrue("output istedigini yapabilirsin olmalı ama sizin output :: " + getOutput(),
				getOutput().toLowerCase().contains("istedigini yapabilirsin"));
	}
	...
	public void age3() {
		...
		Assert.assertTrue("output  facebook hesabi acmak icin cok gencsin olmalı ama sizin output :: " + getOutput(),
				getOutput().toLowerCase().contains("facebook hesabi acmak icin cok gencsin"));
	}
	...
	public void perfectSquare2() {
		...
		Assert.assertTrue("output false olmalı ama sizin output :: " + getOutput(),
				getOutput().toLowerCase().contains("false"));
	}
	...
	public void RandomNumberBetweenTwoNumbers1() {
		...
		Assert.assertTrue("output  70 ile 100 arasinda olmali ama sizin output :: " + getOutput(),
				70 <= num && num <= 100);
	...
	public void RandomNumberBetweenTwoNumbers2() {
		...
		Assert.assertTrue("output  40 ile 70 arasinda olmali ama sizin output :: " + getOutput(),
				40 <= num && num <= 70);
